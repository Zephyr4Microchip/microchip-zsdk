...
### VS Code IDE (Recommended for Ease of Use)
 - [Getting Started with VS Code + Workbench for Zephyr](./wireless-docs/Workbench_for_Zephyr.md)
...
- [Bluetooth LE Applications](./wireless-docs/Bluetooth%20LE%20Applications.md)
- [Open Thread Applications](./wireless-docs/Openthread_Sample_Applications.md)

## 5. Getting Started with OpenOCD<a name="step5">
- Refer the [Getting Started with OpenOCD](./wireless-docs/Getting_Started_with_OpenOCD.pdf)
